                    ...
                    {(embarque.estado === "asignado" ||
                      ...
                      <div className="border-t pt-4">
                        ...
                        <div className="flex flex-col md:flex-row md:items-start ml-8 w-full">
                          ...
                          {/* Contenedor derecho: Tipo de Servicio + Carta Porte (stack en móvil, lado a lado en md+) */}
                          <div className="md:ml-auto md:mr-[28rem] lg:mr-[36rem] mt-2 md:mt-0">
                            <div className="flex flex-col md:flex-row items-start justify-start gap-6 md:text-left">
                              {/* Tipo de Servicio */}
                              <div className="space-y-1">
                                <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                                  Tipo de Servicio
                                ...
                                {(() => {
                                  ...
                                  const [l1, l2] = desc.split(" - ");
                                  return (
                                    <p className="text-sm text-gray-700 max-w-xs md:max-w-sm whitespace-normal break-words leading-tight text-left">
                                      <span className="block">{l1}</span>
                                      {l2 && <span className="block">{l2}</span>}
                                    </p>
                                  );
