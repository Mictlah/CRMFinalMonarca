              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">
                    {operadores.filter((op) => op.documentos).length}
                  </p>
                </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="contactos_emergencia">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        contactos_emergencia: e.target.value,
                      })
                    }
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                          <div className="space-y-1">
                            ...
                            <p className="text-sm font-medium text-gray-900">
                              {operadorDetalle.nombre}{" "}
                              {operadorDetalle.apellidos}
                            </p>
                          </div>
                          <div className="space-y-1">
                            <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                        ...
                        {loadingDocumentos ? (
                          ...
                          <div className="text-center py-8 text-gray-500">
                            ...
                            <p className="text-sm mt-1">
                              Los documentos aparecerán aquí una vez que los
                              subas
                            </p>
                          </div>
                        ) : (
                              ...
                              >
                                ...
                                <div className="aspect-video bg-gray-100 rounded-lg overflow-hidden relative group">
                                  {documento.tipo_mime?.startsWith("image/") ? (
                                    <img
                                      src={
                                        documento.url_blob || "/placeholder.svg"
                                      }
                                    ...
                                    <div className="flex items-center justify-center h-full bg-gray-50">
                                      <div className="text-center">
                                        ...
                                        <span className="text-sm text-gray-500">
                                          {documento.tipo_mime?.includes("pdf")
                                            ? "PDF"
                                            : "Archivo"}
                                        </span>
                                      </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <Textarea
                              ...
                              onChange={(e) =>
                                setNotasDocumento(e.target.value)
                              }
                          ...
                          <Button
                            ...
                            disabled={
                              uploadingDoc || !selectedFile || !tipoDocumento
                            }
                            className="w-full"
                          >
                            {uploadingDoc ? (
