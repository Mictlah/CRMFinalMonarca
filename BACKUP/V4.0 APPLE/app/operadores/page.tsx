                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex space-x-1 ml-2">
                        ...
                        <Button
                          ...
                          onClick={async () => {
                            // Verificar si el operador está asignado a algún embarque
                            const { data: embarquesAsignados, error } =
                              await supabase
                                .from("embarques")
                                .select("id")
                            ...
                            if (error) {
                              window.alert(
                                "Error al verificar embarques asignados"
                              );
                              return;
                            }
                            if (
                              operador.estado === "activo" &&
                              embarquesAsignados &&
                              embarquesAsignados.length > 0
                            ) {
                              window.alert(
                                "No se puede desactivar: operador asignado a un embarque"
                              );
                              return;
                            }
                            // Cambiar estado
