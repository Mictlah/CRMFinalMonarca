        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-2">
            ...
            <Dialog open={showForm} onOpenChange={setShowForm}>
              ...
              <DialogContent className="max-w-5xl md:w-[1100px] w-full h-[65vh] flex flex-col">
                <DialogHeader>
                  <DialogTitle>
                  ...
                  <div className="mt-4 flex-1 overflow-y-auto pr-2">
                    ...
                    {activeTab === "contactos" && (
                      <div className="space-y-6">
                        ...
                        <p className="text-xs text-gray-500 -mt-4">Captura un contacto y pulsa Guardar Contacto. Se listarán abajo. Máximo 5.</p>
                  ...
                  {activeTab === "contactos" && (
                    <div>
                      {selectedClientContacts.length > 0 ? (
                        <div className="space-y-6">
                          {selectedClientContacts.map((contacto, index) => (
                            <div key={contacto.id}>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                                ...
                                {contacto.puesto && (
                                  <div>
                                    <span className="block text-xs text-gray-500">Puesto</span>
                              ...
                              {contacto.notas && (
                                <div className="mb-2">
                                  ...
                                  <span className="text-sm">{contacto.notas}</span>
                                </div>
                              )}
