...
export default function RecordatoriosPage() {
  ...
  const descargarExcel = () => {
    ...
    link.setAttribute(
      "download",
      `recordatorios_${new Date().toISOString().split("T")[0]}.csv`
    );
        ...
        <div className="grid grid-cols-1 gap-4">
          {recordatoriosFiltrados.map((recordatorio) => (
            <Card
              key={recordatorio.id}
              className={
                esVencido(recordatorio.fecha_vencimiento)
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>
                      ...
                      {recordatorio.camion &&
                        ` • Camión: ${recordatorio.camion.numero_economico}`}
                    </CardDescription>
                  </div>
                  <div className="flex items-center space-x-2">
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              permanentemente el recordatorio.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
              ...
              {recordatorio.descripcion && (
                <CardContent>
                  ...
                  <div className="mt-2 text-xs text-gray-400">
                    Creado:{" "}
                    {new Date(recordatorio.fecha_creacion).toLocaleDateString()}
                  </div>
                </CardContent>
              )}
            </Card>
