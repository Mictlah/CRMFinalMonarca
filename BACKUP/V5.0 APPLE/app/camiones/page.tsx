                        ...
                        <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-6">
                          ...
                          <div className="flex items-center">
                            <Button
                              ...
                              className="w-full bg-[#16A34A] hover:bg-[#12813a] text-white font-semibold"
                        ...
                        return (
                          <div className="space-y-6">
                            {(datosAdicionales.numero_serie ||
                              ...
                              <section>
                                <h3 className="text-sm font-semibold text-gray-900">Números de Identificación</h3>
                            ...
                            {datosAdicionales.numeros_adicionales &&
                              Array.isArray(datosAdicionales.numeros_adicionales) &&
                              datosAdicionales.numeros_adicionales.length > 0 && (
                                <section>
                                  <h3 className="text-sm font-semibold text-gray-900">Números Adicionales</h3>
                                  <div className="mt-3 space-y-3">
                                    {datosAdicionales.numeros_adicionales.map((numero: any, index: number) => (
                                          ...
                                          <div>
                                            ...
                                            <p>
                                              {numero.fecha_vencimiento
                                                ? new Date(numero.fecha_vencimiento).toLocaleDateString()
                                                : "No especificado"}
                                            </p>
                                          </div>
                                        </div>
