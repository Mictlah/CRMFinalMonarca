...
import { Truck, Users, Search, Eye, UserCheck, AlertTriangle, Settings } from "lucide-react"
...
export default function AsignarOperadoresPage() {
  ...
  const getEstadoBadge = (estado: string) => {
    const estados = {
      "listo-para-asignar": { color: "bg-blue-100 text-blue-800", label: "Listo para Asignar" },
  ...
  <body>
    ...
    <div class="section">
      ...
      <div class="field full-width">
        ...
        <div class="field-value address-field">${embarqueDetalle.direccion_recolecta || embarqueDetalle.origen || "No especificada"}</div>
      </div>
      <div class="field-group">
        <div class="field">
          <div class="field-label">Fecha de Recolecta</div>
          <div class="field-value">${embarqueDetalle.fecha_recolecta ? new Date(embarqueDetalle.fecha_recolecta).toLocaleDateString() : "No especificada"}</div>
        </div>
        <div class="field">
      ...
      <div class="field full-width">
        ...
        <div class="field-value address-field">${embarqueDetalle.direccion_entrega || embarqueDetalle.destino || "No especificada"}</div>
      </div>
      <div class="field-group">
        <div class="field">
          <div class="field-label">Fecha de Entrega</div>
          <div class="field-value">${embarqueDetalle.fecha_entrega ? new Date(embarqueDetalle.fecha_entrega).toLocaleDateString() : "No especificada"}</div>
        </div>
        <div class="field">
    ...
    <div class="section">
      ...
      <div class="field-group">
        <div class="field">
          ...
          <div class="field-value">${embarqueDetalle.operador ? `${embarqueDetalle.operador.nombre} ${embarqueDetalle.operador.apellidos}` : "Sin asignar"}</div>
        </div>
        <div class="field">
    ...
    <div class="section">
      ...
      <div class="field-group">
        <div class="field">
          ...
          <div class="field-value">${embarqueDetalle.precio_flete ? `$${embarqueDetalle.precio_flete}` : "Sin definir"}</div>
        </div>
        <div class="field">
    ...
    <div class="section">
      ...
      <div class="field full-width">
        <div class="field-value" style="min-height: 60px; background-color: #f9f9f9; padding: 10px;">${embarqueDetalle.observaciones || "Sin observaciones"}</div>
      </div>
    </div>
  </body>
</html>
    ...
    <MainLayout>
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Asignar Operadores</h1>
            <p className="text-gray-600 mt-2">Asignar recursos a embarques listos</p>
          </div>
          <Button
            onClick={() => {
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">Listos para Asignar</p>
                  <p className="text-2xl font-bold text-blue-600">
                    {embarques.filter((e) => e.estado === "listo-para-asignar").length}
                  </p>
                </div>
          ...
          {embarquesFiltrados.map((embarque) => (
            <Card key={embarque.id}>
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="flex space-x-1">
                      ...
                      {(embarque.estado === "asignado" || embarque.estado === "en-transito") && (
                        <Button
                          variant="default"
                          size="sm"
              ...
              <CardContent className="space-y-4">
                ...
                {embarque.modificado && (
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-red-800 font-medium">⚠️ EMBARQUE MODIFICADO</p>
                        <p className="text-red-600 text-sm">
                          Este embarque ha sido modificado por situaciones de emergencia/contingencia
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div
                  className={`rounded-lg border-2 ${embarque.modificado ? "border-red-300 bg-red-50" : "border-gray-200 bg-white"}`}
                >
                  <div className="p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm font-medium text-gray-900">{embarque.cliente?.nombre || "Sin asignar"}</p>
                      </div>
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-gray-700">
                          {(() => {
                            ...
                            return contacto ? `${contacto.nombre} ${contacto.apellidos || ""}` : "No especificado"
                          })()}
                        </p>
                        {(() => {
                          const contacto = contactosClientes.find((c) => c.cliente_id === embarque.cliente?.id)
                          return contacto?.puesto ? <p className="text-xs text-gray-500">{contacto.puesto}</p> : null
                        })()}
                      </div>
                      <div className="space-y-1">
                        <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm font-mono text-gray-900">{embarque.carta_porte || "Sin asignar"}</p>
                      </div>
                      <div className="space-y-1">
                    ...
                    {(embarque.estado === "asignado" || embarque.estado === "en-transito") && (
                      <div className="border-t pt-4">
                        <div className="flex items-center mb-3">
                          ...
                          {embarque.modificado && (
                            <Badge className="ml-3 bg-red-100 text-red-800 text-xs">MODIFICADO</Badge>
                          )}
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-sm font-mono font-medium text-gray-900">
                              {embarque.camion?.numero_economico || "Sin asignar"}
                            </p>
                            {embarque.camion?.marca && <p className="text-xs text-gray-600">{embarque.camion.marca}</p>}
                          </div>
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-sm font-mono font-medium text-gray-900">
                              {embarque.remolque?.numero_economico || "Sin asignar"}
                            </p>
                            {embarque.remolque?.tipo && (
                              <p className="text-xs text-gray-600">{embarque.remolque.tipo}</p>
                            )}
                          </div>
                        </div>
                      </div>
                    ...
                    {embarque.estado === "listo-para-asignar" && (
                      <div className="border-t pt-4">
                        <div className="flex items-center mb-3">
                          ...
                          <h4 className="text-sm font-semibold text-blue-800">Asignar Recursos</h4>
                        </div>
                        ...
                        <div className="bg-gray-50 rounded-lg p-4 border">
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div className="space-y-2">
                              ...
                              <Select
                                value={asignaciones[embarque.id]?.operador_id || ""}
                                onValueChange={(value) =>
                                  setAsignaciones((prev) => ({
                                    ...prev,
                                    [embarque.id]: { ...prev[embarque.id], operador_id: value },
                                  }))
                                }
                              >
                            ...
                            <div className="space-y-2">
                              <Label className="text-sm font-medium text-gray-700">Tractocamión *</Label>
                              <Select
                                value={asignaciones[embarque.id]?.camion_id || ""}
                                onValueChange={(value) =>
                                  setAsignaciones((prev) => ({
                                    ...prev,
                                    [embarque.id]: { ...prev[embarque.id], camion_id: value },
                                  }))
                                }
                              >
                                <SelectTrigger className="bg-white">
                                    ...
                                    camiones.map((camion) => (
                                      <SelectItem key={camion.id} value={camion.id}>
                                        <div className="flex items-center justify-between w-full">
                                          ...
                                          <div className="ml-2">
                                            {camion.estado === "disponible" || camion.estado === "activo" ? (
                                              <div
                            ...
                            <div className="space-y-2">
                              <Label className="text-sm font-medium text-gray-700">Precio Flete *</Label>
                              <div className="flex space-x-2">
                                <Input
                                  ...
                                  required
                                  value={asignaciones[embarque.id]?.precio_flete || ""}
                                  onChange={(e) =>
                                    setAsignaciones((prev) => ({
                                      ...prev,
                                      [embarque.id]: { ...prev[embarque.id], precio_flete: e.target.value },
                                    }))
                                  }
                                />
                                <Select
                                  value={asignaciones[embarque.id]?.moneda_flete || embarque.moneda_flete || "MXN"}
                                  onValueChange={(value) =>
                                    setAsignaciones((prev) => ({
                                      ...prev,
                                      [embarque.id]: { ...prev[embarque.id], moneda_flete: value },
                                    }))
                                  }
                                  required
                                >
                              ...
                              <p className="text-xs text-gray-500">
                                Moneda original del embarque: {embarque.moneda_flete || "MXN"}
                              </p>
                            </div>
                            ...
                            <div className="flex items-end">
                              <Button
                                onClick={() => {
                                  ...
                                  if (!asignacion.precio_flete || asignacion.precio_flete.trim() === "") {
                                    alert("Por favor ingresa el precio del flete")
                                    return
                                  }

                                  if (!asignacion.moneda_flete) {
                                    alert("Por favor selecciona la moneda del flete")
                                    return
                                  }
                                  ...
                                  const confirmacion = confirm(
                                    `¿Estás seguro de que deseas asignar los siguientes recursos al embarque ${embarque.folio}?\n\n` +
                                      `Operador: ${operadorSeleccionado ? `${operadorSeleccionado.nombre} ${operadorSeleccionado.apellidos}` : "No seleccionado"}\n` +
                                      `Tractocamión: ${camionSeleccionado ? `${camionSeleccionado.numero_economico} - ${camionSeleccionado.marca}` : "No seleccionado"}\n` +
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
            <div className="flex justify-between items-center p-6 border-b">
              <div>
                <h2 className="text-xl font-bold text-gray-900">Detalles del Embarque</h2>
                <p className="text-sm text-gray-600">Folio: {embarqueDetalle.folio}</p>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="min-h-[400px]">
                      ...
                      <div className="bg-white border rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center">{getEstadoBadge(embarqueDetalle.estado)}</div>
                          </div>
                          <div className="space-y-1">
                            <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                              Carta Porte
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-sm font-mono font-medium text-gray-900">{embarqueDetalle.folio}</p>
                          </div>
                          <div className="space-y-1">
                            <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                              Contenido
                            </label>
                            <p className="text-sm text-gray-700">{embarqueDetalle.contenido || "No especificado"}</p>
                          </div>
                          <div className="space-y-1">
                            <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">Peso</label>
                            <p className="text-sm text-gray-700">{embarqueDetalle.peso || "No especificado"}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-3">
                              ...
                              <div className="space-y-1">
                                ...
                                <p className="text-sm text-gray-700">{embarqueDetalle.hora_recolecta || "Sin hora"}</p>
                              </div>
                            </div>
                          </div>
                          <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-3">
                              ...
                              <div className="space-y-1">
                                ...
                                <p className="text-sm text-gray-700">{embarqueDetalle.hora_entrega || "Sin hora"}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  {activeTab === "recursos" && (
                    <div className="space-y-6">
                      <div className="bg-white border rounded-lg p-6">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4 border-b pb-2">Recursos Asignados</h3>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div className="bg-gray-50 border rounded-lg p-4">
                            <h4 className="text-sm font-medium text-gray-700 mb-3">Detalles del Operador</h4>
                            <div className="space-y-2">
                              ...
                              {embarqueDetalle.operador?.telefono && (
                                <p className="text-sm text-gray-600">Teléfono: {embarqueDetalle.operador.telefono}</p>
                              )}
                            </div>
                          </div>
                          <div className="bg-gray-50 border rounded-lg p-4">
                            <h4 className="text-sm font-medium text-gray-700 mb-3">Detalles del Tractocamión</h4>
                            <div className="space-y-2">
                              <p className="text-base font-mono font-semibold text-gray-900">
                                {embarqueDetalle.camion?.numero_economico || "Sin asignar"}
                              </p>
                              {embarqueDetalle.camion?.marca && (
                                <p className="text-sm text-gray-600">Marca: {embarqueDetalle.camion.marca}</p>
                              )}
                            </div>
                          </div>
                          <div className="bg-gray-50 border rounded-lg p-4">
                            <h4 className="text-sm font-medium text-gray-700 mb-3">Detalles del Remolque</h4>
                            <div className="space-y-2">
                              <p className="text-base font-mono font-semibold text-gray-900">
                                {embarqueDetalle.remolque?.numero_economico || "Sin asignar"}
                              </p>
                              {embarqueDetalle.remolque?.tipo && (
                                <p className="text-sm text-gray-600">Tipo: {embarqueDetalle.remolque.tipo}</p>
                              )}
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="space-y-6">
                      <div className="bg-white border rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="bg-gray-50 border rounded-lg p-4">
                            <label className="text-sm font-medium text-gray-700 mb-2 block">Precio del Flete</label>
                            <p className="text-2xl font-bold text-gray-900">
                              {embarqueDetalle.precio_flete
                                ? `$${embarqueDetalle.precio_flete} ${embarqueDetalle.moneda_flete || "MXN"}`
                                : "Sin definir"}
                            </p>
                          </div>
                          <div className="bg-gray-50 border rounded-lg p-4">
                            <label className="text-sm font-medium text-gray-700 mb-2 block">Flete en Falso</label>
                      ...
                      <div className="bg-white border rounded-lg p-6">
                        ...
                        <div className="bg-gray-50 border rounded-lg p-4 min-h-[120px]">
                          <p className="text-sm text-gray-900 leading-relaxed">
                            {embarqueDetalle.observaciones || "Sin observaciones registradas"}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Modificaciones Tab */}
                  {activeTab === "modificaciones" && embarqueDetalle?.modificado && (
                    <div className="space-y-6">
                      <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                        <div className="flex items-center mb-4">
                          <AlertTriangle className="h-6 w-6 text-red-600 mr-3" />
                          <h3 className="text-lg font-semibold text-red-800">Historial de Modificaciones</h3>
                        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            <div className="flex justify-between items-center p-6 border-b bg-red-50">
              <div>
                <h2 className="text-xl font-bold text-red-800">Modificar Embarque</h2>
                <p className="text-sm text-red-600">
                  Folio: {embarqueAModificar.folio} - Solo para situaciones de emergencia
                </p>
              </div>
              <Button onClick={() => setShowModifyModal(false)} variant="outline" size="sm">
                ✕
              </Button>
            </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                      ...
                      <textarea
                        ...
                        onChange={(e) => setModificacionData((prev) => ({ ...prev, razon: e.target.value }))}
                      />
                      <p className="text-xs text-gray-600 mt-2">
                        Esta justificación será registrada en el historial de auditoría del embarque.
                      </p>
                    </div>
                  </div>
                )}
                    ...
                    <div className="border rounded-lg p-6">
                      <div className="flex items-center space-x-3 mb-6">
                        <input
                          ...
                          onChange={(e) =>
                            setModificacionData((prev) => ({ ...prev, cambiar_operador: e.target.checked }))
                          }
                          className="w-5 h-5 text-red-600"
                        />
                        <Label htmlFor="cambiar_operador" className="text-lg font-semibold text-gray-800">
                          Cambiar Operador
                        </Label>
                      </div>
                      ...
                      {modificacionData.cambiar_operador && (
                        <div className="space-y-6">
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="bg-gray-50 border rounded-lg p-4">
                              <h4 className="text-sm font-semibold text-gray-700 mb-3">Operador Actual</h4>
                              <div className="space-y-2">
                                <p className="text-base font-medium text-gray-900">
                                ...
                                {embarqueAModificar.operador?.telefono && (
                                  <p className="text-sm text-gray-600">Tel: {embarqueAModificar.operador.telefono}</p>
                                )}
                              </div>
                            </div>

                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-2 block">Nuevo Operador</Label>
                              <Select
                                value={modificacionData.nuevo_operador_id}
                                onValueChange={(value) =>
                                  setModificacionData((prev) => ({ ...prev, nuevo_operador_id: value }))
                                }
                              >
                                ...
                                <SelectContent>
                                  <SelectItem value="no-change">No cambiar</SelectItem>
                                  {operadores.map((operador) => (
                                    <SelectItem key={operador.id} value={operador.id}>
                                      <div className="flex flex-col">
                                        ...
                                        {operador.telefono && (
                                          <span className="text-xs text-gray-500">{operador.telefono}</span>
                                        )}
                                      </div>
                                    </SelectItem>
                                  ))}
                              ...
                              <div>
                                ...
                                <div className="flex space-x-2">
                                  <Input
                                    ...
                                    placeholder="0.00"
                                    className="flex-1"
                                    value={modificacionData.sueldo_operador_original}
                                    onChange={(e) =>
                                      setModificacionData((prev) => ({
                                        ...prev,
                                        sueldo_operador_original: e.target.value,
                                      }))
                                    }
                                  />
                                  <Select
                                    value={modificacionData.moneda_sueldo_operador_original}
                                    onValueChange={(value) =>
                                      setModificacionData((prev) => ({
                                        ...prev,
                              ...
                              <div>
                                ...
                                <div className="flex space-x-2">
                                  <Input
                                    ...
                                    placeholder="0.00"
                                    className="flex-1"
                                    value={modificacionData.sueldo_operador_nuevo}
                                    onChange={(e) =>
                                      setModificacionData((prev) => ({
                                        ...prev,
                                  ...
                                  />
                                  <Select
                                    value={modificacionData.moneda_sueldo_operador_nuevo}
                                    onValueChange={(value) =>
                                      setModificacionData((prev) => ({ ...prev, moneda_sueldo_operador_nuevo: value }))
                                    }
                                  >
                                    <SelectTrigger className="w-20">
                                      <SelectValue />
                    ...
                    <div className="border rounded-lg p-6">
                      <div className="flex items-center space-x-3 mb-6">
                        <input
                          ...
                          onChange={(e) =>
                            setModificacionData((prev) => ({ ...prev, cambiar_camion: e.target.checked }))
                          }
                          className="w-5 h-5 text-red-600"
                        />
                        <Label htmlFor="cambiar_camion" className="text-lg font-semibold text-gray-800">
                      ...
                      {modificacionData.cambiar_camion && (
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          <div className="bg-gray-50 border rounded-lg p-4">
                            <h4 className="text-sm font-semibold text-gray-700 mb-3">Tractocamión Actual</h4>
                            <div className="space-y-2">
                              ...
                              {embarqueAModificar.camion?.marca && (
                                <p className="text-sm text-gray-600">
                                  {embarqueAModificar.camion.marca} {embarqueAModificar.camion.modelo}
                                </p>
                              )}
                            </div>
                          </div>
                          ...
                          <div>
                            <Label className="text-sm font-medium text-gray-700 mb-2 block">Nuevo Tractocamión</Label>
                            <Select
                              value={modificacionData.nuevo_camion_id}
                              onValueChange={(value) =>
                                setModificacionData((prev) => ({ ...prev, nuevo_camion_id: value }))
                              }
                            >
                              <SelectTrigger className="h-12">
                              ...
                              <SelectContent>
                                ...
                                {camiones.map((camion) => (
                                  <SelectItem key={camion.id} value={camion.id}>
                                    <div className="flex flex-col">
                                      <span className="font-mono font-medium">{camion.numero_economico}</span>
                    ...
                    <div className="border rounded-lg p-6">
                      <div className="flex items-center space-x-3 mb-6">
                        <input
                          ...
                          onChange={(e) =>
                            setModificacionData((prev) => ({ ...prev, cambiar_remolque: e.target.checked }))
                          }
                          className="w-5 h-5 text-red-600"
                        />
                        <Label htmlFor="cambiar_remolque" className="text-lg font-semibold text-gray-800">
                          Cambiar Remolque
                        </Label>
                      </div>
                      ...
                      {modificacionData.cambiar_remolque && (
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          <div className="bg-gray-50 border rounded-lg p-4">
                            <h4 className="text-sm font-semibold text-gray-700 mb-3">Remolque Actual</h4>
                            <div className="space-y-2">
                              <p className="text-base font-mono font-medium text-gray-900">
                                {embarqueAModificar.remolque?.numero_economico || "Sin asignar"}
                              </p>
                              {embarqueAModificar.remolque?.tipo && (
                                <p className="text-sm text-gray-600">{embarqueAModificar.remolque.tipo}</p>
                              )}
                            </div>
                          </div>

                          <div>
                            <Label className="text-sm font-medium text-gray-700 mb-2 block">Nuevo Remolque</Label>
                            <Select
                              value={modificacionData.nuevo_remolque_id}
                              onValueChange={(value) =>
                                setModificacionData((prev) => ({ ...prev, nuevo_remolque_id: value }))
                              }
                            >
                              <SelectTrigger className="h-12">
                              ...
                              <SelectContent>
                                ...
                                {remolques.map((remolque) => (
                                  <SelectItem key={remolque.id} value={remolque.id}>
                                    <div className="flex flex-col">
                                      <span className="font-mono font-medium">{remolque.numero_economico}</span>
                                      <span className="text-xs text-gray-500">{remolque.tipo}</span>
                                    </div>
                                  </SelectItem>
                                ))}
                              </SelectContent>
                    ...
                    <div className="border rounded-lg p-6">
                      <div className="flex items-center space-x-3 mb-6">
                        <input
                          ...
                          onChange={(e) =>
                            setModificacionData((prev) => ({ ...prev, cambiar_flete: e.target.checked }))
                          }
                          className="w-5 h-5 text-red-600"
                        />
                        <Label htmlFor="cambiar_flete" className="text-lg font-semibold text-gray-800">
                      ...
                      {modificacionData.cambiar_flete && (
                        <div className="space-y-6">
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="bg-gray-50 border rounded-lg p-4">
                              <h4 className="text-sm font-semibold text-gray-700 mb-3">Precio Flete Actual</h4>
                              <p className="text-xl font-bold text-gray-900">
                                {embarqueAModificar.precio_flete
                                  ? `$${embarqueAModificar.precio_flete} ${embarqueAModificar.moneda_flete || "MXN"}`
                                  : "Sin definir"}
                              </p>
                            </div>

                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-2 block">Nuevo Precio Flete</Label>
                              <div className="flex space-x-2">
                                <Input
                                  type="number"
                                  step="0.01"
                                  ...
                                  onChange={(e) =>
                                    setModificacionData((prev) => ({ ...prev, nuevo_precio_flete: e.target.value }))
                                  }
                                />
                                <Select
                                  value={modificacionData.nueva_moneda_flete}
                                  onValueChange={(value) =>
                                    setModificacionData((prev) => ({ ...prev, nueva_moneda_flete: value }))
                                  }
                                >
                          ...
                          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                            <div className="flex items-center space-x-3">
                              <input
                                ...
                                onChange={(e) =>
                                  setModificacionData((prev) => ({ ...prev, flete_en_falso: e.target.checked }))
                                }
                                className="w-5 h-5 text-red-600"
                              />
                              <div>
                                <Label htmlFor="flete_en_falso" className="text-sm font-semibold text-red-800">
                                  Marcar como Flete en Falso
                                </Label>
                                <p className="text-xs text-red-600 mt-1">
                                  Esta opción indica que el flete no se realizó o fue cancelado
                                </p>
                              </div>
                            </div>
                          </div>
            ...
            <div className="border-t p-6 bg-gray-50">
              <div className="flex justify-end space-x-3">
                <Button onClick={() => setShowModifyModal(false)} variant="outline">
                  Cancelar
                </Button>
                <Button
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
            <div className="flex justify-between items-center p-6 border-b">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Embarques finalizados y archivados ({embarquesFinalizados.length} registros)
                </p>
              </div>
              <Button onClick={() => setShowCompletedModal(false)} variant="outline" size="sm">
                ✕
              </Button>
            </div>
              ...
              <div className="p-6">
                ...
                {loadingCompleted ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-gray-500">No hay registros completados disponibles</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {embarquesFinalizados.map((embarque) => (
                      <Card key={embarque.id} className="border-l-4 border-l-green-500">
                        <CardContent className="pt-6">
                          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                            <div className="space-y-1">
                              <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">Folio</label>
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="text-sm font-mono text-gray-700">
                                {embarque.camion?.numero_economico || "Sin camión"}
                              </p>
                            </div>
                            <div className="space-y-1">
                              <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">
